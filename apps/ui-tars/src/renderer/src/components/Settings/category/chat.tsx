        ...
        <form className="space-y-8">
            ...
            render={({ field }) => {
              return (
                <FormItem>
                  ...
                  <FormDescription>控制 LLM 对话使用的语言</FormDescription>
          ...
          <FormField
            ...
            render={({ field }) => {
              return (
                <FormItem>
                  <FormLabel>最大步骤数</FormLabel>
                  <FormDescription>输入一个 25-200 之间的整数</FormDescription>
                  <FormControl>
                    <Input
                      type="number"
                      {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>输入一个 0-3000 之间的数字</FormDescription>
                <FormControl>
                  <Input
                    type="number"
                    placeholder="输入一个 0-3000 之间的数字"
                    {...field}
                    value={field.value === 0 ? '' : field.value}
                    onChange={(e) => field.onChange(Number(e.target.value))}
                  />
